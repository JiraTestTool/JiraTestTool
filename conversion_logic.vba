...
Private Sub helperFunc4(iRow, iCol)
  ' bold the header row'
...
Private Sub helperFunc3(iRow, copyString, iCount, stringIndex)
...
Private Sub bt_convert_Click()
  ...
  '++++++++++ BARS FUNCTION VARIABLES
    ...
    iCol = 2
  '--------------------------- ALGORITHM --------------------
    Call helperFunc(rowIndex, vbNullString)
    ...
    Call helperFunc3(iRow, copyString, iCount, stringIndex)
